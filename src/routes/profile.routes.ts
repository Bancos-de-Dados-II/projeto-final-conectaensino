...
profileRoutes.patch('/avatar', requireAuth, requireRoles('student', 'authenticated', 'director'), AccountProfileController.avatar);
profileRoutes.patch('/institution', requireAuth, requireRoles('student', 'authenticated', 'director'), AccountProfileController.institution);
